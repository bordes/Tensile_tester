...
module plate(){
    translate([-50,-225,-5])color("grey")
    difference(){
        roundedCube(dimensions=[350,450,5], cornerRadius= 10);
        translate([100,145,-1])roundedCube(dimensions=[200,160,7], cornerRadius= 10);
    }
}
...
translate([-15,115,25])rotate([0,0,-90])z_axis();
translate([50,-150,0])full_guide_left();
translate([50,210,0])full_guide_right();
plate();
